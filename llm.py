...
fashion_model_path = "/Users/musfiraaslam/Desktop/makehuman-mastercopy42/3d-model/check-point1400"
...
def generate_core_attributes(description, fashion_fields):
    ...
    - name: A suitable name for the character (one word name only, no capital letters)
    ...
    - export_path: "/Users/musfiraaslam/Desktop/makehuman-mastercopy42/3d-model/output/[name].fbx"  
    (replace [name] with lowercase, no spaces)
    ...
    "tongue": "tongue01",
    "skeleton": "game_engine",
    "export_path": "/Users/musfiraaslam/Desktop/makehuman-mastercopy42/3d-model/output/generated_name.fbx"
    }}
