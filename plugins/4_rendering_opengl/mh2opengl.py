...
def Render(settings):
    ...
    if not mh.hasRenderToRenderbuffer():
        ...
        renderprog = Progress()
        renderprog(0, 0.99 - 0.59 * settings['AA'], None)
    ...
    if settings['lightmapSSS']:
        progress(0.98, 0.99, None)
        human.material = materialBackup

    progress(1, None, None)
